...
def calculate_score(delt_cards):
  card_sum=sum(delt_cards)
  if card_sum==21:
    return 0
  elif card_sum>21 and 11 in delt_cards:
    delt_cards.remove(11)
    delt_cards.append(1)
    return sum(delt_cards)
  else:
    return card_sum
...
while input("Do you wanna play bla")